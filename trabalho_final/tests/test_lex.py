...
class TestLexer:
    ...
    @pytest.mark.parametrize("machine, program, expected_tokens", [
        ...
        ([src.constants.afd_ident, src.constants.afd_blank], """hsd ghsd321  k234 bvcb afsd_1234_ __234 _2a""", [('IDENT', 'hsd', 1, 1), ('IDENT', 'ghsd321', 1, 5), ('IDENT', 'k234', 1, 14), ('IDENT', 'bvcb', 1, 19), ('IDENT', 'afsd_1234_', 1, 24), ('IDENT', '__234', 1, 35), ('IDENT', '_2a', 1, 41)]),
